var app = angular.module('website', []).
            config(function($routeProvider) {
                $routeProvider.
                    when('/social', {template:'partials/social.html', controller:SocialCtrl}).
                    when('/photos', {template:'partials/photos.html', controller:PhotosCtrl}).
...
function PhotosCtrl($scope) {
    $scope.title = 'Photos';
    $scope.body = 'This is the social page body';
    $(".message").hide();
    $("#gallery").hide();
